              ...
              if (disabled == true) {
                     let waiting = setInterval(function () {
                            if (disabled == false) {
                                   ...
                                   let i = 0
                                   let Roles = ["1112993277193494538", "1085497928027750470", "1085505731698118737", "1095940988926697613", "1095941802390986812", "1112925030154764308", "1112925696067637258", "1095941808053301288", "1095941809055748226", "1095942288619880458", "1097673828022370465", "1095942287860707449"]
                                   ...
                                   setTimeout(() => {
                                          ...
                                          let addrole = setInterval(function () {
                                                 ...
                                                 if (rover.guilds.cache.get("846548733914906664").members.cache.get(array[i].id).roles.cache.has("1125569213101244488")) {
                                                        i++
                     ...
                     setTimeout(() => {
                            ...
                            let addrole = setInterval(function () {
                                   ...
                                   if (!rover.guilds.cache.get("846548733914906664").members.cache.get(array[i].id)?.roles) return i++
                            ...
                            //             if (rover.guilds.cache.get("846548733914906664").members.cache.get(BotArray[i].id).roles.cache.has("1125569213101244488")) {
